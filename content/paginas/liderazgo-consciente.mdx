...
eyebrow: "LIDERAZGO"
senales:
  - titulo: "Nadie le da malas noticias a tiempo."
    texto: "Los problemas le llegan cuando ya son incendios. Su gente hizo un cálculo y decidió que el costo de avisarle temprano es mayor que el de esperar. Ese cálculo es información sobre él, no sobre ellos."
  - titulo: "Las juntas tienen dos versiones."
    texto: "Está lo que se dice en la sala y lo que se dice en el pasillo diez minutos después. Cuando la conversación real ocurre siempre fuera de la junta, el líder está gobernando una organización que no existe."
  - titulo: "El equipo directo rota más que el resto de la empresa."
    texto: "La gente no renuncia a la empresa, renuncia a con quién trabaja. Si un área pierde tres personas buenas en un año mientras el resto de la compañía está estable, ahí no hay un problema de mercado laboral."
  - titulo: "Todo depende de su humor."
    texto: "Las prioridades cambian según cómo llegó el lunes. El equipo desarrolla una habilidad tristísima: leerle la cara en la entrada para saber qué tipo de semana viene. Esa energía debería estar en el cliente."
  - titulo: "Delega tareas pero no decisiones."
    texto: "Reparte trabajo y retiene el control. Después se queja de que su equipo no toma iniciativa. La iniciativa no crece donde la corrigen."
  - titulo: "Confunde la crítica al proyecto con la crítica a su persona."
    texto: "Alguien objeta un plan y él lo vive como deslealtad. En seis meses, ya nadie objeta nada. El proyecto se cae solo, con testigos silenciosos."
  - titulo: "Habla de valores que no practica."
    texto: "Es la más cara de todas. Una cultura declarada que no se sostiene con conducta no produce indiferencia: produce desprecio. La gente perdona a un jefe duro mucho más rápido de lo que perdona a uno incongruente."
indicadores:
  - titulo: "Baja el tiempo entre el problema y el aviso."
    texto: "Este es mi favorito porque casi nadie lo mide. ¿Cuántos días pasan entre que alguien detecta algo y te lo dice? Cuando el líder deja de castigar al mensajero, ese número se desploma. Y con él, el costo de los errores."
  - titulo: "Baja la rotación no deseada en el equipo directo."
    texto: "No la rotación total; la de la gente que querías conservar. Es el indicador más caro de todos y el que más rápido responde."
  - titulo: "Bajan las decisiones tomadas dos veces."
    texto: "Las que se anuncian el lunes y se corrigen el jueves. Casi siempre nacen de la prisa o de la necesidad de mostrar movimiento. Un líder que reconoce su propia ansiedad decide menos veces y mejor."
  - titulo: "Sube la calidad del desacuerdo."
    texto: "No la cantidad de acuerdos: la calidad de las discusiones. Se nota en cuántas personas hablan en una junta y en si aparecen objeciones antes de la decisión y no después."
  - titulo: "Mejoran los resultados de clima y los de riesgo psicosocial."
    texto: "El apartado de liderazgo en cualquier encuesta de clima suele ser el que más se mueve, y en las mediciones de factores de riesgo psicosocial se ve en las secciones de relaciones en el trabajo y liderazgo. No es magia: son las preguntas que apuntan directo a la conducta del jefe."
  - titulo: "Sube la velocidad de ejecución."
    texto: "Esta sorprende a mucha gente. Cuando el equipo deja de gastar energía en descifrar al jefe, esa energía se va al trabajo. La organización se vuelve más rápida sin contratar a nadie."
...
enlacesTalentoria:
  - url: "https://talentoria.com/capacitacion-personal/"
    anchor: "los programas de desarrollo humano que Talentoría diseña y ejecuta"
...
Esa segunda lista es la que más me sirve hoy en las conversaciones que mantengo con líderes y áreas de recursos humanos. Casi nadie llega diciendo "quiero ser mejor persona". Llegan diciendo "no entiendo por qué mi equipo no me dice las cosas".
...
**No es terapia.** Yo elegí no dar terapia, entre otras cosas porque no tengo la paciencia de escuchar el mismo problema cinco veces sin que alguien accione. En los programas que articulamos desde Talentoría lo interior se mira porque impacta decisiones, presupuestos, personas y resultados. Si no aterriza ahí, no es el tema.
...
Después viene el trabajo, que en mi experiencia tiene tres piezas: espacios de conversación donde el líder pueda pensar en voz alta sin quedar expuesto, herramientas prácticas que se apliquen en su operación real —sus juntas, sus conversaciones difíciles, sus decisiones de la semana— y algún mecanismo de seguimiento que evite que todo se diluya al mes tres. Esa es la lógica de TALENTORIA_1: siempre atados a la operación de quien participa, no a un temario genérico. Quien diseña y ejecuta esos programas es Talentoría, con el especialista que corresponda en cada caso; mi papel está antes, en entender qué necesita realmente la organización.
